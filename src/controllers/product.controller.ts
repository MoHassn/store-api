...
export const getAllProducts = async (_req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .send({ message: 'An Error occurred while getting products' });
  }
};
...
export const getProduct = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(500)
      .send({ message: 'An Error occurred while getting product' });
  }
};
...
export const createProduct = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(500)
      .send({ message: 'An Error occurred while creating product' });
  }
};
